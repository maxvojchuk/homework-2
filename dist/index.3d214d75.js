...
const debouncedMoveBox = (0, _lodashDefault.default).debounce((event)=>{
    let x = event.clientX;
    let y = event.clientY;
...
},{"./node_modules/lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3qBDj":[function(require,module,exports,__globalThis) {
var global = arguments[3];
(function() {
